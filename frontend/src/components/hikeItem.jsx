...
const HikeItem=({data,onClick})=> {
  ...
  return (   
            ...
            <div key={data.hikeid} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-lg transition-all" onClick={onClick}>
